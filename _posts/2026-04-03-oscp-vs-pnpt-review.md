...
The PNPT focuses on demonstrating a realistic network penetration test, with external reconnaissance, internal exploitation, and compromise of the domain controller as the main objective. It allows five full days for the assessment, and the exam also includes a live debrief after the report.
The PNPT also includes an OSINT component, which makes the exam feel more like a full attacker workflow, from initial recon through internal compromise and reporting.
