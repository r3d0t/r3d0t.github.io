...
description: >-
  Testing with writing a first post. Just experimenting
author: r3d0t
date: 2026-01-18 12:14:00 -0500
categories: [First Posts, Tests]
tags: [first post]
pin: true
media_subpath: '/posts/20260118'
---

## First edit - Checking Title

I'm testing the header

### Smaller header now 

This approach simplifies upgrades, isolates unnecessary files, and is perfect for users who want to focus on writing with minimal configuration.

1. checking what this does [**testing**][testing].
2. Click the <kbd>what is this</kbd> button and then select <kbd>something here</kbd>.
...
- If you have committed `Gemfile.lock`{: .filepath} to the repository, and your local machine is not running Linux, update the platform list of the lock file:
  ...
  ```console
  # This looks like it's the syntax for a code block
  $ sudo nano testing
  ```
