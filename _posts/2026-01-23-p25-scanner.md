...
- OS: [pentoo](https://pentoo.ch/about)
...
> New to Pentoo? See my [Pentoo installation guide](/_posts/2026-01-18-pentoo-installation.md). 
{: .prompt-tip}
...
Under `Assets`, we have all the compiled and compressed binaries for that version. Since we are on pentoo, which is linux x64, we will download the `sdr-trunk-linux-x86_64-v0.6.1.zip` file
...
Let's visit [RadioReference](https://www.radioreference.com)
...
Let's use it in our playlist. This is what our playlist looks like
